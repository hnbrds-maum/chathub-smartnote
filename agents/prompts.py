...
GENERATE_RAG_ANSWER_SYSTEM = """Refer to the given context(Document Search Results & Web Search Results), and answer the user's question and make a short title for the conversation.
...
- If there are URL in the metadata or websearch results, use [CITATION FORMAT: URL] format.

[CITATION FORMAT: Documents]
- [<CITATION_NUMBER>](btn:<DOC_ID>/<HEADING_ID>)
- ex) [2](btn:d4b0de35-6b77-4971-a07e-af3dbe31e41d/8855ed9e-9128-4774-a538-e5a53b843393)

[CITATION FORMAT: URL]
- [<CITATION_NUMBER>](<URL>)
- ex) [2](https:www.google.com)
...
GENERATE_RAG_ANSWER_USER = """{% if documents %}[Document Search Results]
{{documents}}{% endif %}{% if web_search_results %}
[Web Search Results]
{{web_search_results}}{% endif %}
